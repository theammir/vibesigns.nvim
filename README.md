...
```lua
{
  'theammir/gitsigns-vibecoded.nvim',
  dependencies = { 'lewis6991/gitsigns.nvim' },
  opts = {
    agent_emails = { -- has all the popular ones configured by default
      'noreply@anthropic.com',   -- exact match
      { 'domain', 'devin.ai' },  -- any address @devin.ai
    },
  },
}
```
